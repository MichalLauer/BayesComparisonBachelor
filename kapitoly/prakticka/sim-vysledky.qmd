...
Jednotlivé čtverce označují odhady pro různé populační parametry $p$ spolu
...
interval je užší. Čím větší je absolutní vzdálenost mezi skutečnou hodnotou
a odhadem, tím více se liší bayesovský a Willsonův odhad. U hraničních
...
zkoumat chybu I. druhu. Obrázek @fig-sim-errorI ukazuje vývoj chyby podle
skutečné populační hodnoty a s rostoucí velikostí vzorku $n$. 
...
absolutní vzdáleností od $p = 0,05$ je chyba však velmi nestabilní a u 
...
konvergencí. U některých parametrů (např. $p = 0,55$) je chyba I. druhu v 
...
hodnot. S rostoucí absolutní vzdáleností parametru $p$ od hodnoty $0,05$
