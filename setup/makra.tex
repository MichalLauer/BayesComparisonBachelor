...
\lstnewenvironment{code}[3]{
  ...
  \lstset{
    ...
    otherkeywords={set.seed,binom.test,file.path,bugs,jags.model,update.jags,coda.samples,
    seq_along,effectiveSize,stan},
    deletekeywords={q,lower,upper,data,_,model.file,save,beta,path,file,model,variable.names}
  } 
}{}
...
\lstnewenvironment{model}[3]{
  ...
  \lstset{
    ...
    For,scale,factor,variable,real,se_,diag_,__,on,split}
  } 
}{}
